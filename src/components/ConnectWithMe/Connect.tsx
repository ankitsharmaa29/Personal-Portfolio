...
const socialLinks = [
  {
    ...
    text: "LinkedIn",
    color: "text-blue-500",
    href: "https://www.linkedin.com/in/ankitsharmaa29/",
  },
  {
    icon: BsInstagram,
    text: "Instagram",
    color: "text-red-500",
    href: "https://www.instagram.com/ankitsharmaa29",
  },
  {
    icon: BsFacebook,
    text: "Facebook",
    color: "text-blue-600",
    href: "https://www.facebook.com/ankitsharmaa29",
  },
  {
    icon: BsTelegram,
    text: "Telegram",
    color: "text-blue-400",
    href: "https://t.me/ankitsharmaa29",
  },
  {
    icon: BsTwitter,
    text: "Twitter",
    color: "text-black",
    href: "https://x.com/ankitsharmaa29",
  },
];
    ...
    <div ref={connectRef} className="px-4 mt-10">
      ...
      >
        ...
        <div className="lg:flex lg:flex-wrap grid grid-cols-2 items-center justify-center gap-4">
          ...
          >
            <Link
              href="mailto:as2486178@gmail.com"
