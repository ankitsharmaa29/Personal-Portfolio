...
import DSA from "@/assets/asset dsa.svg"
import Dbms from "@/assets/asset_dbms.svg";
import ComputerNetwork from "@/assets/asset_cn.svg";
import OS from "@/assets/asset_os.svg";
import SQL from "@/assets/asset_sql.svg";
import Python from "@/assets/asset_python.svg";
import PowerBI from "@/assets/asset_powerbi.svg";
...
const skillsData: Skill[] = [
  ...
  { id: 17, image: Dbms, name: "DBMS" },
  { id: 18, image: ComputerNetwork, name: "Computer Network" },
  { id: 19, image: OS, name: "Operating System" },
  { id: 20, image: SQL, name: "SQL" },
  { id: 21, image: Python, name: "Python" },
  { id: 22, image: PowerBI, name: "Power BI" },
